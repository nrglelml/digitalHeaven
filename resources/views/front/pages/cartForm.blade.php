...
@section('content')
    ...
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                < <div class="col-md-12 mb-0"><a href="{{route('home')}}">Ana Sayfa</a> <span class="mx-2 mb-0">/</span> <a href="{{route('cart')}}" text-decoration="none">Sepet</a>
                    <span class="mx-2 mb-0">/</span> <strong class="text-black">Ödeme</strong></div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row mb-5">
                            <div class="col-md-12">
                                ...
                                <div class="p-3 p-lg-5 border">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-primary btn-lg py-3 btn-block" type="submit">Ödemeyi Tamamla</button>
                                    </div>
