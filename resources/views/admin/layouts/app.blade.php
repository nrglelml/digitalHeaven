            ...
            <i class="icon-layout menu-icon"></i>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="tables">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item{{ Route::is('setting.index') ? 'active' : '' }}"> <a class="nav-link" href="{{route('setting.index')}}">Site Ayarları</a></li>
                            <li class="nav-item {{ Route::is('setting.edit') ? 'active' : '' }}"> <a class="nav-link" href="{{route('setting.edit')}}">Site Ayarları Düzenle</a></li>
                        </ul>
                    </div>
                </li>
